...
const routes = [
    ...
    { path: 'login', loadChildren: () => __webpack_require__.e(/*! import() | modules-login-login-module */ "modules-login-login-module").then(__webpack_require__.bind(null, /*! ./modules/login/login.module */ "./src/app/modules/login/login.module.ts")).then(m => m.LoginModule) },
    { path: 'customers', loadChildren: () => __webpack_require__.e(/*! import() | modules-customers-customers-module */ "modules-customers-customers-module").then(__webpack_require__.bind(null, /*! ./modules/customers/customers.module */ "./src/app/modules/customers/customers.module.ts")).then(m => m.CustomersModule) },
    { path: 'orders', loadChildren: () => __webpack_require__.e(/*! import() | modules-orders-orders-module */ "modules-orders-orders-module").then(__webpack_require__.bind(null, /*! ./modules/orders/orders.module */ "./src/app/modules/orders/orders.module.ts")).then(m => m.OrdersModule) },
    { path: 'homes', loadChildren: () => __webpack_require__.e(/*! import() | homes-homes-module */ "homes-homes-module").then(__webpack_require__.bind(null, /*! ./homes/homes.module */ "./src/app/homes/homes.module.ts")).then(m => m.HomesModule) },
    { path: 'homy', loadChildren: () => __webpack_require__.e(/*! import() | modules-homy-homy-module */ "modules-homy-homy-module").then(__webpack_require__.bind(null, /*! ./modules/homy/homy.module */ "./src/app/modules/homy/homy.module.ts")).then(m => m.HomyModule) }
];
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 13, vars: 0, consts: [[1, "navbar", "navbar-expand-sm", "bg-dark", "navbar-dark"], [1, "navbar-nav"], [1, "nav-item"], ["routerLink", "/customers", 1, "nav-link"], ["routerLink", "/orders", 1, "nav-link"], ["routerLink", "/login", 1, "nav-link"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _modules_test_test_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/test/test.module */ "./src/app/modules/test/test.module.ts");
/* harmony import */ var _guards_route_guard_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./guards/route-guard.service */ "./src/app/guards/route-guard.service.ts");
...
/* harmony import */ var _interceptors_http_error_interceptor__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./interceptors/http-error.interceptor */ "./src/app/interceptors/http-error.interceptor.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [_guards_route_guard_service__WEBPACK_IMPORTED_MODULE_5__["RouteGuardService"], _services_data_service__WEBPACK_IMPORTED_MODULE_7__["DataService"], {
            ...
            _modules_test_test_module__WEBPACK_IMPORTED_MODULE_4__["TestModule"],
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](TestModule, { imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"]] }); })();
...
class DataService {
    constructor(httpClient) {
        ...
        this.REST_API_SERVER = 'https://api.railwayapi.com/v2/name-number/train/';
    ...
    sendGetRequest(trainNo) {
        this.url = this.getUrl(trainNo);
        return this.httpClient.get(this.url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(response => {
            return response;
        }));
    }
    getUrl(trainNo) {
...
module.exports = __webpack_require__(/*! C:\Users\qbuser\Praseetha\Angular\demo-prj\src\main.ts */"./src/main.ts");
