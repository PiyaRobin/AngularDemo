...
/* harmony import */ var _signup_signup_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./signup/signup.component */ "./src/app/modules/login/signup/signup.component.ts");
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 17, vars: 0, consts: [[1, "container-fluid"], [1, "row"], [1, "col-sm-4", 2, "background-color", "lavender"], ["action", ""], [1, "form-group"], ["for", "usr"], ["type", "text", "id", "usr", "name", "username", 1, "form-control"], ["for", "pwd"], ["type", "password", "id", "pwd", "name", "password", 1, "form-control"], ["type", "submit", 1, "btn", "btn-primary"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
